...
trigger.forEach(item => item.addEventListener("click", () => {
    if (item.dataset.project === 'photobomb') {
        ...
        modalContent.insertAdjacentHTML("beforeend",
            '<div class="modal-content__container" data-projectContent = "delete"><div class="modal-text"><a href="./projects/01drum/index.html" class="project-link" target="_blank">Drum machine</a><br>Wow! It&#39;s a drum machine.</div><div class="modal-img-container"><img class="modal-img" src="img/1drum-machine.PNG"></div></div> ');
        ...
        modalContent.insertAdjacentHTML("beforeend",
            '<div class="modal-content__container" data-projectContent = "delete"><div class="modal-text"><a href="./projects/03variables/index.html" class="project-link" target="_blank">CSS variables work with js</a><br>Wow! It&#39;s a CSS variables without a SASS, and JS can change it! Amazing.</div><div class="modal-img-container"><img class="modal-img" src="img/3css-variables-inter.png"></div></div> ');
    } else if (item.dataset.project === 'array') {
        modalContent.insertAdjacentHTML("beforeend",
            '<div class="modal-content__container" data-projectContent = "delete"><div class="modal-text"><a href="./projects/04array/index.html" class="project-link" target="_blank">Array methods </a><br>Wow! It&#39;s a bunch of array methods and tasks with them.</div><div class="modal-img-container"><img class="modal-img" src="img/4array-methods.png"></div></div>');
